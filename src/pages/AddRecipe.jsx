...
//             <option value="light"> {t("sad")} </option>
//             <option value="sweet"> {t("stressed")}</option>
//             <option value="quick"> {t("tired")}</option>
//             <option value="fancy"> {t("relaxed")}</option>
//             <option value="fancy"> {t("happy")}</option>
//             <option value="fancy"> {t("bored")}</option>
//             <option value="fancy"> {t("anxious")}</option>
//             <option value="fancy"> {t("energetic")}</option>
//             <option value="fancy"> {t("romantic")}</option>
//         </select>
...
import { useTranslation } from "react-i18next";
import { useNavigate } from "react-router-dom";
import { AuthContext } from "../context/AuthContext"; // عدلي المسار حسب المشروع
...
function AddRecipe() {
  ...
  // 👮‍♀️ الحماية من الدخول غير المصرح به
